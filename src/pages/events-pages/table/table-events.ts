...
@IonicPage()
@Component({
  selector: 'page-table-events',
  templateUrl: 'table-events.html'
})
export class TableEventsPage implements OnInit {
  students: IRecord[] = [];
  ...
  constructor(public navParams: NavParams, public viewCtrl: ViewController, private db: AmaranthusDBProvider, private alertCtrl: AlertController, private modalCtrl: ModalController) {}
